...
def cpu_attention_forward(q, k, v, use_causal_mask=True, mixed_precision=True, q_segment_ids=None, kv_segment_ids=None):
...
class TestAttention:
    ...
    @pytest.mark.parametrize("bs, nheads, seqlen_q, seqlen_k, d, dtype, use_causal_mask,\
                              mixed_precision, training, tile_size, kv_heads, should_transpose_v, seq_packed, latency", [
    [1, 6, 32*1024, 32*1024, 96, nl.bfloat16, True, True, True, 2048, 3, False, False, 87000000000],
    [1, 1, 32*1024, 32*1024, 96, nl.bfloat16, True, True, False, 2048, None, False, False, 15100000000],

    # square seq packing
    [1, 1, 2*1024, 2*1024, 96, nl.bfloat16, False, True, False, 2048, None, False, True, 15100000000],
    [1, 1, 2*1024, 2*1024, 96, nl.bfloat16, True, True, False, 2048, None, False, True, 15100000000],

    # Non-square
    [1, 3, 32*1024, 16*1024, 96, nl.bfloat16, True, True, False, 2048, None, False, False, 7550000000],
    [1, 3, 16*1024, 32*1024, 96, nl.bfloat16, True, True, False, 2048, None, False, False, 7550000000],
    ])
    def test_flash_attn_fwd_perf(self, bs, nheads, seqlen_q, seqlen_k, d, dtype, use_causal_mask, 
        ...
        bench_func_(q, k, v, seed, use_causal_mask=use_causal_mask,  q_segment_ids_tile_ref=q_segment_ids_tile_ref, 
